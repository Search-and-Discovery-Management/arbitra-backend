...
use crate::{actions::EClient, handlers::errors::ErrorTypes, DEFAULT_ELASTIC_SHARDS, DEFAULT_ELASTIC_REPLICAS};
...
pub async fn create_or_exists_index(app_id: Option<String>, index: &str, shards: Option<usize>, replicas: Option<usize>, partition: Option<usize>, client: &EClient) -> StatusCode {
            ...
            json!(
                {
                    ...
                    "settings": {
                        "index.number_of_shards": shards.unwrap_or(DEFAULT_ELASTIC_SHARDS),
                        "index.number_of_replicas": replicas.unwrap_or(DEFAULT_ELASTIC_REPLICAS),
                    }
                }
            );
...
pub async fn index_exists(app_id: &str, index_name: &str, client: &EClient) -> Result<(usize, Vec<String>), (StatusCode, ErrorTypes, Vec<String>)> {
