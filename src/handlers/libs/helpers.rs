...
use crate::{actions::EClient, handlers::{libs::index_exists, errors::ErrorTypes}};
...
pub async fn check_server_up_exists_app_index(app_id: &str, index: &str, client: &EClient) -> Result<(), (StatusCode, ErrorTypes)>{
